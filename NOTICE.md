...
| **Las 11 texturas de `textures/`** | **son de StewardClan, puestas como placeholder** |

## AVISO sobre las texturas

Las once texturas de clan (iconos, silueta, estandarte, retrato y los tres bordes de carta)
son **arte original de StewardClan** copiado tal cual para que el clan cargue y se vea
coherente desde el primer arranque.
